...
- **Sprint 11 — Local LLM gateway + cited RAG answer path:** **PARTIAL**. Phase 1 + Phase 2A mock-safe foundation **PASS**; Sprint 11 hardening tests **PASS** (commit `c102f51`, 25 new tests, total 56 files / 733 tests; see `reports/ITERLAW_SPRINT_11_LOCAL_LLM_RAG_GATEWAY_QA_2026-05-13.md`). Phase 2B (live HTTP transport) and Phase 4 (pipeline wiring) **NOT STARTED**, pending ADR + operator approval. Closeout ADR: [`docs/iterlaw/project/11-ai-governance/ADR_SPRINT_11_LOCAL_LLM_TRANSPORT_AND_PIPELINE_WIRING.md`](docs/iterlaw/project/11-ai-governance/ADR_SPRINT_11_LOCAL_LLM_TRANSPORT_AND_PIPELINE_WIRING.md). Implementation plan: [`docs/iterlaw/project/07-sprints/SPRINT_11_CLOSEOUT_IMPLEMENTATION_PLAN.md`](docs/iterlaw/project/07-sprints/SPRINT_11_CLOSEOUT_IMPLEMENTATION_PLAN.md). Task contract: [`docs/iterlaw/project/07-sprints/SPRINT_11_LOCAL_LLM_RAG_GATEWAY_TASKS.md`](docs/iterlaw/project/07-sprints/SPRINT_11_LOCAL_LLM_RAG_GATEWAY_TASKS.md).
