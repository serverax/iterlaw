/**
 * Cache / answer safety gate: whether a qa_pool_entries row may be served to users.
 * Row-driven checks only; no routes (STEP 2+).
 */
...
export async function canServeAnswer(
  sb: SupabaseClient,
  answerId: string
): Promise<CanServeAnswerResult> {
