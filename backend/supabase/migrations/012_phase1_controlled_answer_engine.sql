-- Phase 1 — Controlled Legal Answer Engine (AEE + safety gate)
-- No AI in this layer: only approved qa_pool, trusted_content extracts, or under_review.
-- Coexists with qa_pool_entries / review_queue (Axiom pipeline).
...
-- Deterministic audit trail (no PII beyond question text)
